    ...
    public async Task SummaryExcludesFutureDeparturesOfToday()
    {
        ...
        await _fixture.Db.UpsertObservationsBatchAsync([
            new Dictionary<string, object?> {
                ...
                ["realtime_departure"] = pastSecs, ["arrival_delay"] = 0, ["departure_delay"] = 60,
            ...
            new Dictionary<string, object?> {
                ...
                ["scheduled_departure"] = futureSecs, ["realtime_arrival"] = futureSecs - 100,
                ["realtime_departure"] = futureSecs, ["arrival_delay"] = 0, ["departure_delay"] = 30,
                ["realtime"] = 1, ["realtime_state"] = "UPDATED",
                ["queried_at"] = DateTimeOffset.UtcNow.ToUnixTimeSeconds(),
            },
        ]);
